              ...
              <div class="info row">
                <div class="wrap row">
                  ...
                  <div class="content row">
                    ...
                    <div>
                      <div class="title">Телефон: <span class="text">#phone_link#</span></div>
                      <div class="title">Email: <span class="text">#email_link#</span></div>
        ...
        <div class="pop-up-body">
          <form id="user-form" class="post">
            ...
            <div class="form-wrap" required>
              ...
              <input type="text" value="" name="position" data-type="text" placeholder="Введите должность" maxlength="40">
            </div>
            <div class="form-cols">
              <div class="form-wrap form-col2" required>
