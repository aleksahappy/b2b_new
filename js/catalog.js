...
// Установка ширины малых карточек товаров (принимает ширину в em):
...
function toggleEventListeners(toggle) {
  if (toggle === 'on') {
    ...
    window.removeEventListener('scroll', setFiltersHeight);
    window.removeEventListener('resize', setFiltersHeight);
  }
}
